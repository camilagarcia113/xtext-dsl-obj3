 ...
 * </p>
 * <ul>
 *   <li>{@link ar.edu.unq.aventuraGrafica.Acciones#getObjeto <em>Objeto</em>}</li>
 * </ul>
 *
 * @see ar.edu.unq.aventuraGrafica.AventuraGraficaPackage#getAcciones()
 * @model
 * @generated
 */
public interface Acciones extends Comando
{
  /**
   ...
   * @see ar.edu.unq.aventuraGrafica.AventuraGraficaPackage#getAcciones_Objeto()
   * @model
   * @generated
   */
  Objeto getObjeto();
  ...
  /**
   * Sets the value of the '{@link ar.edu.unq.aventuraGrafica.Acciones#getObjeto <em>Objeto</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
